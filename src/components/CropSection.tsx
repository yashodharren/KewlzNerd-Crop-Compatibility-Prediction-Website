const crops = [
  ...
  {
    name: 'Rice',
    image: 'https://images.unsplash.com/photo-1568347355280-d33fdf77d42a?ixlib=rb-1.2.1&auto=format&fit=crop&w=1920&q=80',
    description: 'Premium rice varieties adapted for optimal yields.',
    benefits: ['Water efficient', 'Disease resistant', 'High grain quality']
  }
];
